...
function Profile() {
  ...
  const { data: _reactedItems, isLoading: _reactedItemsLoading } =
    useUserReactedItems(convexUser?.externalId || '');
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mb-8">
            ...
            <MasonryFeed
              ...
              variant="category"
              showLoadMoreTarget={false}
              emptyStateTitle="no items created yet"
              emptyStateDescription="share your first item with the community!"
              emptyStateAction={
                <CreateItemButton
                  variant="default"
            ...
            {!itemsLoading && items && items.length > 6 && (
              <div className="mt-6 text-center">
                ...
                >
                  <a href="/items/my-items">
                    view all items ({items.length} total)
                  </a>
                </Button>
              </div>
            )}
