...
export function HeroTitle({ onComplete }: HeroTitleProps) {
  ...
  return (
    <div
      className={`text-foreground flex select-none items-center justify-center bg-transparent transition-opacity duration-1000`}
    >
      ...
      <div className="pointer-events-none relative z-10 flex flex-col items-center justify-center gap-4 px-4">
        <h1 className="text-foreground text-4xl font-[200] tracking-tight transition-colors duration-200 sm:text-5xl">
