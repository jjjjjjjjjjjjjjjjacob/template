  ...
  projects: [
    {
      ...
      description:
        'Led development of a sophisticated motion capture marketplace platform connecting viral movements with gaming. Architected full-stack TypeScript ecosystem with real-time 3D animation processing.',
...

    {
      ...
      description:
        'Founded and architected innovative social platform for sharing life experiences with emoji-based rating system. Built real-time application using cutting-edge TanStack ecosystem and Convex backend.',
